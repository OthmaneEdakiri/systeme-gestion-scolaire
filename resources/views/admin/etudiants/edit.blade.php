...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Modifier l'Étudiant</h1>
        ...
        <form action="{{ route('admin.etudiants.update', $etudiant) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="password" name="password" id="password"
                    placeholder="Enter a new password if you want to change it" value="{{ old('password') }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="date" name="date_naissance" id="date_naissance"
                    value="{{ old('date_naissance', $etudiant->date_naissance) }}" required min="1"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
