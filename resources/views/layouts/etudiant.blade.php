...
<head>
    ...
    <title>Étudiant @hasSection('title')- @yield('title')@endif</title>
        ...
        <div class="max-w-6xl mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <nav class="flex items-center gap-6">
                    <a href="{{ route('etudiant.dashboard') }}" class="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-white/10 transition-colors {{ request()->routeIs('etudiant.dashboard') ? 'bg-white/20' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        Dashboard
                    </a>
                    <a href="{{ route('etudiant.notes') }}" class="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-white/10 transition-colors {{ request()->routeIs('etudiant.notes') ? 'bg-white/20' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm">{{ $etudiant->prenom ?? 'Étudiant' }}</span>
                    </div>
